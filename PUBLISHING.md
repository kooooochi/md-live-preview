...
数分で https://marketplace.visualstudio.com/items?itemName=kooooochi.markdown-sync-studio に表示されます。
...
- [ ] `code --install-extension kooooochi.markdown-sync-studio` で実機検証
